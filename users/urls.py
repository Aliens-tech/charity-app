...
urlpatterns = [
    ...
    path('get/data/',views.GetUserCurrentDataAPI.as_view(), name='get-current-user-data'),
    path('get/data/<int:user_id>/', views.GetUserProfileAPI.as_view(), name='get-user-data'),
